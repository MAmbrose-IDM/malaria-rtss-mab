...
Malaria_Drug_Params = {
      ...
      "Amodiaquine": {
        ...
        "Fractional_Dose_By_Upper_Age": [
          {
            "Fraction_Of_Adult_Dose": 0.376,
            "Upper_Age_In_Years": 1
          }
        ],
        "Max_Drug_IRBC_Kill": 0.23
      },
      ...
      "Primaquine": {
        ...
        "Drug_Gametocyte02_Killrate": 2,
        "Drug_Gametocyte34_Killrate": 5,
        "Drug_GametocyteM_Killrate": 50,
      ...
      "Pyrimethamine": {
        ...
        "Max_Drug_IRBC_Kill": 0.38502000000000003
      },
      "Sulfadoxine": {
        "Bodyweight_Exponent": 1,
        "Drug_Adherence_Rate": 1,
        ...
        "Drug_GametocyteM_Killrate": 0,
        "Drug_Hepatocyte_Killrate": 0,
        "Drug_PKPD_C50": 1.2000000000000002,
        "Drug_Vd": 1,
        "Fractional_Dose_By_Upper_Age": [
          {
            "Fraction_Of_Adult_Dose": 0.167,
...
def update_drugs(list_drug_param, value,
                 list_drug_param2=[], value2=0,
                 list_drug_param3=[], value3=0,
    ...
    if len(list_drug_param3) == 1:
        malaria_drug_params[list_drug_param3[0]] = value3
    elif len(list_drug_param3) == 2:
        malaria_drug_params[list_drug_param3[0]][list_drug_param3[1]] = value3
    elif len(list_drug_param3) == 3:
        malaria_drug_params[list_drug_param3[0]][list_drug_param3[1]][list_drug_param3[2]] = value3

    if len(list_drug_param4) == 1:
        malaria_drug_params[list_drug_param4[0]] = value4
    elif len(list_drug_param4) == 2:
        malaria_drug_params[list_drug_param4[0]][list_drug_param4[1]] = value4
    elif len(list_drug_param4) == 3:
        malaria_drug_params[list_drug_param4[0]][list_drug_param4[1]][list_drug_param4[2]] = value4
