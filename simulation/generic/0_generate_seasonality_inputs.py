...
def create_eir_seasonality():
    """create seasonality files with monthly EIR rescaling values
    ...
    df = pd.DataFrame(
        data={'month': month, 'high_unimodal': eir_high, 'moderate_unimodal': eir_med, 'constant': eir_flat,
    ...
    df.to_csv(os.path.join(projectpath, 'simulation_inputs/scenario_files/generic', 'Seasonality',
